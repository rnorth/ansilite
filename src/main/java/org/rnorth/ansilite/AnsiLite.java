...
import static org.rnorth.ansilite.CapabilityDetection.*;
...
public class AnsiLite {
    ...
    public static boolean isEnabled() {
        ...
        /* Allow ANSI support to be forced on or off (by setting -ansilite.enabled=true|false) */
        if (System.getProperty("ansilite.enabled") != null) {
            return Boolean.getBoolean("ansilite.enabled");
        }
        ...
        if (Boolean.getBoolean("ansilite.passthrough")) {
            return true;
        }
